...
The unhealthy event caused by missing heartbeat lead to execution of repair action on the instances marked as unhealthy. The automatic healing of instances using <a href="/documentation/user/references/auto-repair.html">Auto-Repair</a> helps in recovery of instances back to good state.
